(* OASIS_START *)
(* DO NOT EDIT (digest: f4576bc2d9265c518031b67524fd3ad8) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "ppx_driver";
                      lib_findlib_name = Some "runner";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "ppx_driver_runner";
                      lib_findlib_name = Some "as-ppx";
                      lib_findlib_containers = []
                   })
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some ",\016!\004\238\169\178$\029\138\029j\156\181\210\177";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
